...
./configure --host=mipsel-linux --with-sdl-exec-prefix=`mipsel-linux-gcc -print-sysroot`/usr --disable-opengl --disable-alsa-midi --disable-dynamic-x86 --disable-fpu-x86 --enable-core-inline CXXFLAGS="-g3 -O0 -G0 -mips32r2 -pipe -fno-builtin -fno-common -mno-shared -ffast-math -fomit-frame-pointer -fexpensive-optimizations -frename-registers -Wno-narrowing" LIBS="-lSDL_gfx -lSDL_image"
